...
import thefortress.relics.BaseRelic;
import thefortress.util.GeneralUtils;
import thefortress.util.KeywordInfo;
import thefortress.util.TextureLoader;
...
@SpireInitializer
public class TheFortressMod implements
    ...
    private static final String resourcesFolder = "thefortress";
    ...
    private static final Color cardColor = new Color(28f/255f, 165/255f, 25f/255f, 1f);
    ...
    public static void initialize() {
        ...
        BaseMod.addColor(TheFortress.Enums.CARD_COLOR, cardColor,
                BG_ATTACK, BG_SKILL, BG_POWER, ENERGY_ORB,
                BG_ATTACK_P, BG_SKILL_P, BG_POWER_P, ENERGY_ORB_P,
                SMALL_ORB);
    }

    public TheFortressMod() {
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(TheFortressMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new TheFortress(),
                CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT, TheFortress.Enums.THE_FORTRESS);
    }
