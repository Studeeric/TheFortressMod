package thefortress.cards;

import basemod.abstracts.CustomCard;
import thefortress.TheFortressMod;
...
import static thefortress.util.TextureLoader.getCardTextureString;
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    TheFortressMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
