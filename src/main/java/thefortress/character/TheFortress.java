...
import static thefortress.TheFortressMod.characterPath;
import static thefortress.TheFortressMod.makeID;

public class TheFortress extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Fortress"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_FORTRESS;
        @SpireEnum(name = "FORTRESS_GRAY_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "FORTRESS_GRAY_COLOR") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;
    }

    public TheFortress() {
        super(NAMES[0], Enums.THE_FORTRESS,
